...
class NotAdmin(Exception):
    ...
    def to_dict(self):
        rv = dict(self.payload or ())
        rv['status'] = 'error'
        rv['message'] = self.message or '403 Access Denied. You must be an admin of this organization.'
        return rv
...
def handle_not_admin(error):
    if request_wants_json():
        ...
        return render_template('errors/403_organization_admin.html'), 403
